...
- If new project (not fork):
  - Copy [saudacepiercing.com project files](https://github.com/saudacepiercing/saudacepiercing.com)
...
- `README.md` ⏩ edit baseURL ("saudacepiercing.com") + delete steps bit by bit
- Design
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/saudacepiercing/domains)
  - `Set up a custom domains`
  - `saudacepiercing.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.saudacepiercing.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/saudacepiercing/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de saudacepiercing.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/saudacepiercing/forms)
...
1. [Servicios saudacepiercing.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
